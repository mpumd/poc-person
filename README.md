...
```bash
# run with dev profile which is define inside a special runner inside test folder of bootstrap module
mvn -T 1C clean install -DskipTests && mvn spring-boot:test-run -pl infra-spring/sb-bootstrap/
```
